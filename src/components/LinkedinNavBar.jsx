    ...
    <header className='nav-container'>
      <Navbar collapseOnSelect bg='dark' variant='dark' className='p-0' id='navbar' fixed='top'>
        <Container fluid='xl' className='justify-content-start'>
          ...
          <Nav>
            <Link to='/' className='d-flex flex-column justify-content-center align-items-center py-1'>
            ...
            <Link to={"/jobsPage"} className='d-flex flex-column justify-content-center align-items-center py-1'>
