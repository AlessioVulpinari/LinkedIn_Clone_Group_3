      ...
      <div className="px-2 nav-card-profile">
        <div className="d-flex flex-column pb-2 border-bottom">
          <div className="d-flex align-items-center mb-2 pointer">
            <img src="" alt="id" width="60px" height="60px" className="me-2 rounded-circle objectfit-cover" />
            <div className="d-flex flex-column">
              <p className="m-0 fs-5 fw-semibold">Luca Dipietro</p>
              <p className="m-0">Junior Full Stack Web Developer</p>
            </div>
          </div>
